...
export function LoginPanelTestimonial() {
  ...
  return (
    <figure className="relative z-10 mx-auto mt-8 w-full max-w-[88%] shrink-0 px-5 pb-0 pt-0">
      <blockquote className="text-[13px] leading-[1.55] text-[#F4F7FA]">
        <span
          className="mr-0.5 inline font-display text-[22px] leading-none text-[#F2C94C]/40"
          aria-hidden
        >
          “
        </span>
        {QUOTE}
        <span
          className="ml-0.5 inline font-display text-[22px] leading-none text-[#F2C94C]/40"
          aria-hidden
        >
          ”
        </span>
