...
import { CircleHelp, CreditCard, History, BarChart3, CalendarRange, Mail, Menu, Settings } from 'lucide-react'
      ...
      >
        <div className="flex flex-col gap-1 p-2">
          ...
          <Button
            ...
            className="w-full justify-start gap-2 text-foreground hover:bg-muted"
          >
            <Link href="/history-performance" onClick={closeMenu}>
          ...
          <Button
            ...
            className="w-full justify-start gap-2 text-foreground hover:bg-muted"
          >
            <Link href="/settings/billing" onClick={closeMenu}>
