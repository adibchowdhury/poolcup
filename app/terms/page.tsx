      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-12 space-y-10 text-foreground">
          ...
          <section id="ai-insights" className="scroll-mt-24">
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              Optional AI Insights are generated by an AI model (Anthropic
              Claude) from your own aggregated prediction statistics. We send
              only those aggregates to the model — not other users&apos; data.
              How that processing works is described in our{' '}
              <Link href="/privacy" className="text-primary underline-offset-4 hover:underline">
                Privacy Policy
              </Link>
              .
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              Insights are informational and for entertainment. They may be
              inaccurate or incomplete. They are not betting, gambling, or
              financial advice, and you should not rely on them as such. PoolCup
              is a prediction game; no real-money wagering occurs on the
              platform.
            </p>
          </section>

          <section>
            <h2 className="font-display text-2xl tracking-wide">8. Acceptable Use</h2>
            <p className="mt-3 leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 className="font-display text-2xl tracking-wide">12. Termination</h2>
            <p className="mt-3 leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 className="font-display text-2xl tracking-wide">14. General</h2>
            <p className="mt-3 leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 className="font-display text-2xl tracking-wide">15. Contact Us</h2>
            <p className="mt-3 leading-relaxed text-muted-foreground">
